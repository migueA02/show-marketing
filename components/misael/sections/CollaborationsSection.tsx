    ...
    >
      ...
      >
        ...
        <div className="w-full mb-6 sm:mb-8 md:mb-10 lg:mb-12 relative">
          ...
          <button
            onClick={prevVideo}
            className="absolute left-4 w-10 h-10 md:w-12 md:h-12 bg-white/50 hover:bg-white/70 rounded-full flex items-center justify-center text-[#854319] transition-colors z-10"
          ...
          <button
            onClick={nextVideo}
            className="absolute right-4 w-10 h-10 md:w-12 md:h-12 bg-white/50 hover:bg-white/70 rounded-full flex items-center justify-center text-[#854319] transition-colors z-10"
            style={{ top: arrowTop ? `${arrowTop}px` : "50%", transform: "translateY(-50%)" }}
